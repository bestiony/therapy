                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12">
                        <div class="page-banner-content text-center">
                            <h3 class="page-banner-heading text-white pb-15">{{$user->name. ' '. __('Support Tickets') }}</h3>

                            <!-- Breadcrumb Start-->
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center">
                                    <li class="breadcrumb-item font-14"><a href="{{ url('/') }}">{{ __('Home') }}</a></li>
                                    <li class="breadcrumb-item font-14"><a href="{{ route('support-ticket-faq') }}">{{$user->name. ' '. __('Support Tickets') }}</a></li>
                    ...
                    <div class="col-12">
                        ...
                        <div class="tab-content live-class-list" id="myTabContent">
                            <div class="tab-pane fade show active" id="create_new_ticket" role="tabpanel" aria-labelledby="create_new_ticket-tab">
                                <form action="{{ route('student.support-ticket.organization.store',['organization'=>$organization->id]) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
