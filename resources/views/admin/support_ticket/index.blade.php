                                        ...
                                        <tr class="removable-item">
                                            ...
                                            <td>
                                                <div class="action__buttons">
                                                    <a href="{{ route('support-ticket.admin.show', $ticket->uuid) }}"
                                                        class=" btn-action mr-1" title="View Ticket Details">
                                                        <img src="{{ asset('admin/images/icons/eye-2.svg') }}"
                                                            alt="eye">
                                                    </a>
                                                    <a href="javascript:void(0);"
                                                        data-url="{{ route('support-ticket.admin.delete', [$ticket->uuid]) }}"
