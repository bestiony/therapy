...
<div class="modal fade" id="consultationBookingModal" tabindex="-1" aria-labelledby="consultationBookingModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class=" bg-white rounded ">
                <!-- Rounded tabs -->
                <ul id="myTab" role="tablist" class="nav nav-tabs nav-pills flex-column flex-sm-row text-center bg-light border-0 rounded-nav px-4 py-2">
                  <li class="nav-item flex-sm-fill">
                    <a id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true" class="nav-link border-0 text-uppercase font-weight-bold active">Session</a>
                  </li>
                  <li class="nav-item flex-sm-fill">
                    <a id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false" class="nav-link border-0 text-uppercase font-weight-bold">Monthly</a>
                  </li>
                ...
                <div id="myTabContent" class="tab-content">
                  ...
                  <div id="profile" role="tabpanel" aria-labelledby="profile-tab" class="tab-pane fade px-4 py-2">
                    <div class="row booking-header-row consultation-select-date-hour">
                        <div class="input-group flex-nowrap col-md-6 consultantion-calendar-box">
                            <label class="col-md-5 col-form-label font-17 font-semi-bold color-heading">{{ __('Starting Date') }}:</label>
                                <div class="book-schedule-calendar-wrap position-relative appendStartingDatePicker">
                                   <!-- Append from booking.js -->
                                </div>
                        </div>
                        <div class="input-group col-md-6 consultantion-hours-box">
                            <label class="col-md-3 col-form-label font-17 font-semi-bold color-heading">{{ __('Monthly Rate') }}</label>
                            <input type="text" class="form-control font-medium monthly_rate" disabled value="0">
 ...
 <div class="  d-flex booking-header-row align-items-center ">
                ...
                <label class="my-0 mx-2" for="#agreedToTerms"><a target="_blank" href="{{route('terms-conditions')}}"> {{get_option('accept_terms_message')}}</a></label>
            </div>
    ...
    document.addEventListener("DOMContentLoaded", function(){
        ...
        tabList.forEach(function(tab){
            ...
            tab.addEventListener("click", function(event){
                ...
                tabTrigger.show();
                clientOrderType.value = tab.text
