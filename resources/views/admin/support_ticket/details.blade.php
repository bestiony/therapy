                                        ...
                                        <div class="col-12 col-md-12 col-lg-8 col-xl-8">
                                            <div class="ticket-details-left-part">
                                                ...
                                                <div class="ticket-details-reply-form-box ticket-details-box radius-4 p-20">
                                                    ...
                                                    <form action="{{ route('support-ticket.admin.messageStore') }}"
                                        ...
                                        <div class="col-12 col-md-12 col-lg-4 col-xl-4">
                                            <div class="ticket-details-right-part ticket-details-box radius-4 p-20">
                                                ...
                                                @if ($ticket->organization && $ticket->instructor)
                                                    ...
                                                    <div class="ticket-info-bottom-box">
                                                        <div class="ticket-info-content">
                                                            <p>{{ __('Concerned Organization') }} : <a
                                                                    href="{{ route('userProfile', ['user' => $organization->id]) }}">
                                                                    {{ $organization->name }}</a></p>
                                                            <p>{{ __('Concerned Instructor') }} : <a
                                                                    href="{{ route('userProfile', ['user' => $user->id]) }}">
                                                                    {{ $user->name }}</a></p>
