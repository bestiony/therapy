                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="75%"
                                ...
                                <tr>
                                    <td align="left">
                                        ...
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                                            We are thrilled to have you as a client for our tutorial services. Thank you
                                            for your recent payment! We appreciate your trust in us and we are committed
                                            to providing you with the best possible experience on our platform.
                                        </div>
                                        <div style="height: 20px; line-height: 20px; font-size: 8px;">&nbsp;</div>
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                                            If you have any questions or concerns about the tutorial process or the
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="255">
                                <tr>
                                    <td align="center" valign="middle" height="44"
                                        ...
                                        <a href="{{ route('student.my-course.show', ['slug' => $data['course_slug']]) }}"
