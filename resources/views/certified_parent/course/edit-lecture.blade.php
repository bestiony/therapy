                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            ...
                                                            <div class="row mb-30">
                                                                <div class="col-md-12 main-upload-video-processing-item-btns">
                                                                    ...
                                                                    <a href="{{route('instructor.course.edit', [$course->uuid, 'step=lesson','course_version_id'=>$course_version_id])}}" class="theme-btn default-hover-btn default-back-btn theme-button3">{{__('Back')}}</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
