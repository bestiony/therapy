...
class ProfileController extends Controller
{
    ...
    public function __construct(CertifiedParent $parent, User $user)
    {
        $this->model = new Crud($parent);
    ...
    public function profile()
    {
        ...
        $data['user'] = Auth::user();
        $data['certified_parent'] = Auth::user()->certified_parent;
        $data['skills'] = Skill::where('status',1)->get();
        $data['languages'] = Course_language::all();
        return view('certified_parent.profile', $data);
    }
    ...
    public function address()
    {
        ...
        return view('certified_parent.address', $data);
    }
