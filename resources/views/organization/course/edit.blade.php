                        ...
                        <div id="msform">
                            ...
                            <div class="upload-course-step-item upload-course-overview-step-item">
                                ...
                                <div id="upload-course-overview-1">
                                    <form method="POST"
                                        action="{{ route('organization.course.update.overview', [$course->uuid]) }}"
                                                ...
                                                <ul class="mb-30">
                                                    @foreach ($rules as $rule)
                                                        <li><span class="iconify"
                                                                data-icon="akar-icons:arrow-right"></span>{{ $rule->description }}
                                                        </li>
                                                    @endforeach
                                                </ul>
                                            ...
                                            @if (get_option('subscription_mode'))
                                                <div class="row mb-30">
                                                    <div class="col-md-12">
                                                        ...
                                                        <select name="is_subscription_enable" id="is_subscription_enable"
                                                            ...
                                                            @if ($keyPoints->count() > 0)
                                                                @foreach ($keyPoints as $keyPoint)
                                                                    <label for="name_{{ $keyPoint['id'] }}"
                                                                        class="text-lg-right text-black">
                                                                        {{ __('Name') }} </label>
