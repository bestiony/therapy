                        ...
                        <form action="{{ route('settings.general_setting.cms.update') }}" method="post"
                            ...
                            <div class="row input__group mb-25">
                                <label class="col-lg-3">{{ __('App Copyright') }} <span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" name="app_copyright" value="{{ get_option('app_copyright') }}"
                                        class="form-control" required>
                                </div>
                            </div>
                            ...
                            <div class="row input__group mb-25">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="app_developed" value="{{ get_option('app_developed') }}"
                                        class="form-control" required>
                                </div>
                            </div>

                            <div class="row input__group mb-25">
                                <label for="app_date_format" class="col-lg-3">{{ __('Date Format') }} <span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <select name="app_date_format" class="form-control">
                                        <option value="m/d/Y"
                                            {{ get_option('app_date_format') == 'm/d/Y' ? 'selected' : '' }}>
                                            m/d/Y (eg. {{ \Carbon\Carbon::now()->format('m/d/Y') }} )
                                        </option>
                                        <option value="d/m/Y"
                                            {{ get_option('app_date_format') == 'd/m/Y' ? 'selected' : '' }}>
                                            d/m/Y (eg. {{ \Carbon\Carbon::now()->format('d/m/Y') }} )
                                        </option>
                                        <option value="Y/m/d"
                                            {{ get_option('app_date_format') == 'Y/m/d' ? 'selected' : '' }}>
                                            Y/m/d (eg. {{ \Carbon\Carbon::now()->format('Y/m/d') }} )
                                        </option>
                                        <option value="Y/d/m"
                                            {{ get_option('app_date_format') == 'Y/d/m' ? 'selected' : '' }}>
                                        ...
                                        <option value="d F, Y"
                                            {{ get_option('app_date_format') == 'd F, Y' ? 'selected' : '' }}>
                                            d F, Y (eg. {{ \Carbon\Carbon::now()->format('d F, Y') }} )
                                        </option>
                                        <option value="Y F, d"
                                            {{ get_option('app_date_format') == 'Y F, d' ? 'selected' : '' }}>
                            ...
                            <div class="row input__group mb-25">
                                <label for="app_date_format" class="col-lg-3">{{ __('Default Currency') }} <span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-9">
                            ...
                            <div class="row input__group mb-25">
                                <label for="app_date_format" class="col-lg-3">{{ __('Default Language') }} <span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-9">
                            ...
                            <div class="row input__group mb-25">
                                <label class="col-lg-3">{{ __('Platform Charge') }} (%) <span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="number" min="0" max="100" name="platform_charge"
                                        value="{{ get_option('platform_charge') }}" class="form-control" required>
                                </div>
                            </div>

                            <div class="row input__group mb-25">
                                <label class="col-lg-3"> {{ __('Sell Commission') }} (%) <span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="number" min="0" max="100" name="sell_commission"
                                        value="{{ get_option('sell_commission') }}" class="form-control" required>
                                </div>
                            </div>

                            <div class="row input__group mb-25">
                                <label for="allow_preloader" class="col-lg-3">{{ __('Allow Preloader') }} <span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <select name="allow_preloader" class="form-control">
                                        <option value="">{{ __('Select Option') }}</option>
                                        <option value="1" @if (get_option('allow_preloader') == 1) selected @endif>
                                            {{ __('Active') }}</option>
                                        <option value="0" @if (get_option('allow_preloader') != 1) selected @endif>
                                            {{ __('Disable') }}</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row input__group mb-25">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <p><span class="text-black">{{ __('Accepted Files') }}:</span> PNG, SVG <br> <span
                                            class="text-black">{{ __('Recommend Size') }}:</span> 118 x 40</p>
                                </div>
                            </div>
                            <div class="row input__group mb-25">
                            ...
                            <div class="row input__group mb-25">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    @endif
                                    <p><span class="text-black">{{ __('Accepted Files') }}:</span> PNG, SVG <br> <span
                                            class="text-black">{{ __('Recommend Size') }}:</span> 16 x 16</p>
                                </div>
                            </div>

                            <div class="row input__group mb-25">
                                <label class="col-lg-3">{{ __('Sign up Left Text') }} <span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" name="sign_up_left_text"
                                        value="{{ get_option('sign_up_left_text') }}" class="form-control">
                                </div>
                            </div>

                            <div class="row input__group mb-25">
                                <label for="allow_preloader" class="col-lg-3">{{ __('Registration Email Verification') }}
                                    <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <select name="registration_email_verification" class="form-control">
                                        <option value="">{{ __('Select Option') }}</option>
                                        <option value="1" @if (get_option('registration_email_verification') == 1) selected @endif>
                                            {{ __('Active') }}</option>
                                        <option value="0" @if (get_option('registration_email_verification') != 1) selected @endif>
                                            {{ __('Disable') }}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row input__group mb-25">
                                <label for="allow_preloader"
                                    class="col-lg-3">{{ __('Registration Phone Number Verification') }} <span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <select name="registration_phone_number_verification" class="form-control">
                                        <option value="">{{ __('Select Option') }}</option>
                                        <option value="1" @if (get_option('registration_phone_number_verification') == 1) selected @endif>
                                            {{ __('Active') }}</option>
                                        <option value="0" @if (get_option('registration_phone_number_verification') != 1) selected @endif>
                                            {{ __('Disable') }}</option>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="upload-img-box">
                                        ...
                                        @else
                                            <img src="{{ asset('uploads/default/no-image-found.png') }}">
                                        @endif
                                        <input type="file" name="sign_up_left_image" id="sign_up_left_image"
                            ...
                            <div class="row input__group mb-25">
                                <label class="col-lg-3">{{ __('Forgot Title') }} <span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" name="forgot_title" value="{{ get_option('forgot_title') }}"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="row input__group mb-25">
                            ...
                            <div class="row input__group mb-25">
                                <label class="col-lg-3">{{ __('Accept Terms Message') }} <span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" name="accept_terms_message"
                                        value="{{ get_option('accept_terms_message') }}" class="form-control">
                                </div>
                            </div>
                            <div class="row input__group mb-25">
                            ...
                            <div class="item-top mb-30">
                                <h2>{{ __('Twilio API Keys') }}</h2>
                            </div>
                            <div class="row input__group mb-25">
                                <label class="col-lg-3">{{ __('Twilio SID') }} <span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" name="twilio_sid" value="{{ get_option('TWILIO_SID') }}"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="row input__group mb-25">
                                <label class="col-lg-3">{{ __('Twilio Auth Token') }} <span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" name="twilio_auth_token"
                                        value="{{ get_option('TWILIO_AUTH_TOKEN') }}" class="form-control">

                                </div>
                            </div>
                            <div class="row input__group mb-25">
                                <label class="col-lg-3">{{ __('Twilio Verify SID') }} <span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" name="twilio_verify_sid"
                                        value="{{ get_option('TWILIO_VERIFY_SID') }}" class="form-control">
                            ...
                            <div class="row input__group mb-25">
                                <label class="col-lg-3">{{ __('Facebook URL') }} <span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" name="facebook_url" value="{{ get_option('facebook_url') }}"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="row input__group mb-25">
                                <label class="col-lg-3">{{ __('Twitter URL') }} <span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" name="twitter_url" value="{{ get_option('twitter_url') }}"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="row input__group mb-25">
                                <label class="col-lg-3">{{ __('LinkedIn URL') }} <span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" name="linkedin_url" value="{{ get_option('linkedin_url') }}"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="row input__group mb-25">
                            ...
                            <div class="row input__group mb-25">
                                <label class="col-lg-3">{{ __('Status') }} <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <select value="{{ get_option('podcast_status') }}" name="podcast_status"
                                        id="">
                                        <option value="1" {{ get_option('podcast_status') == 1 ? 'selected' : '' }}>{{ __('ON') }}</option>
                                        <option value="0" {{ get_option('podcast_status') == 0 ? 'selected' : '' }}>{{ __('OFF') }}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
