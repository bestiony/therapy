            ...
            <section id="discussions" class="discussions col-12 col-sm-4  overflow-auto position-relative">
                ...
                @forelse ($conversations as $convo)
                    ...
                    <div
                        ...
                        <div class="photo" style="background-image: url({{ asset($convo->therapist ? $convo->therapist->image : '') }});">
                            {{-- <div class="online"></div> --}}
                            <a class="stretched-link" href="{{ route('student.messages', ['convo' => $convo->id]) }}"></a>
                        </div>
                        <div class="desc-contact">
                            <p class="name">{{ $convo->therapist ? $convo->therapist->name : "" }} [O-{{ $convo->order->id }}]</p>
