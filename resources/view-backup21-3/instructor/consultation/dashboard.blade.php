            ...
            <div class="are-you-available-box mb-30">
                <form action="{{ route('instructor.consultation.instructorAvailabilityStoreUpdate') }}" method="post">
                    ...
                    <div class="mb-3 row instructor-panel-monthly-rate-box align-items-center">
                        <label for="monthly_rate" class="col-sm-2 col-form-label font-medium color-heading">{{ __('Monthly Rate')}}{{ get_currency_symbol() }}</label>
                        <div class="col-sm-6 col-md-3">
                            <input type="number" step="any" min="0" name="monthly_rate" class="form-control" id="monthly_rate" placeholder="Ex.20"
                                   value="{{ $instructor->monthly_rate }}">
                        </div>
                        @if ($errors->has('monthly_rate'))
                            <span class="text-danger"><i class="fas fa-exclamation-triangle"></i> {{ $errors->first('monthly_rate') }}</span>
                        @endif
                    </div>
                    {{-- monthly rate --}}

                    <div class="mb-3 row instructor-panel-monthly-rate-box align-items-center">
                        <label for="hours_per_month" class="col-sm-2 col-form-label font-medium color-heading">{{ __('Hours Per Month')}}</label>
                        <div class="col-sm-6 col-md-3">
                            <input type="number" step="any" min="0" name="hours_per_month" class="form-control" id="hours_per_month" placeholder="Ex.20"
                                   value="{{ $instructor->hours_per_month }}">
                        </div>
                        @if ($errors->has('hours_per_month'))
                            <span class="text-danger"><i class="fas fa-exclamation-triangle"></i> {{ $errors->first('hours_per_month') }}</span>
                        @endif
                    </div>
                    <div class="mb-3 row instructor-panel-monthly-rate-box align-items-center">
                        <label for="monthlyOldRate" class="col-sm-2 col-form-label font-medium color-heading">{{ __('Monthly Old Rate') }} {{ get_currency_symbol() }}</label>
                        <div class="col-sm-6 col-md-3">
                            <input type="number" step="any" min="0" name="monthly_old_rate" class="form-control" id="monthlyOldRate" placeholder="Ex.20"
                                   value="{{ $instructor->monthly_old_rate }}">
                        </div>
                        @if ($errors->has('monthly_old_rate'))
                            <span class="text-danger"><i class="fas fa-exclamation-triangle"></i> {{ $errors->first('monthly_old_rate') }}</span>
                        @endif
                    </div>
                    <div class="mb-3 row instructor-panel-monthly-rate-box align-items-center">
                        <label for="monthlyOldRate" class="col-sm-2 col-form-label font-medium color-heading">{{ __('Booking Note') }}</label>
                        <div class="col-sm-6 col-md-3">
                            <input type="text" step="any" min="0" name="booking_note" class="form-control" id="bookingNote" placeholder=""
                                   value="{{ $instructor->booking_note }}">
                        </div>
                        @if ($errors->has('booking_note'))
                            <span class="text-danger"><i class="fas fa-exclamation-triangle"></i> {{ $errors->first('booking_note') }}</span>
                        @endif
                    </div>
