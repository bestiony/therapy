...
Route::group(['as' => 'student.'], function () {
    ...
    //Start:: patient <> therapist messages
    Route::get('my-messages',[MessagesController::class,'patient_index'])->name('messages');
    Route::post('my-messages/send',[MessagesController::class,'patient_sends_message'])->name('send_message');

    //End::patient <> therapist messages
