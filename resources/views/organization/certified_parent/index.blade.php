    ...
    <div class="instructor-profile-right-part">
        <div class="instructor-quiz-list-page instructor-all-student-page">
            <div class="instructor-my-courses-title d-flex justify-content-between align-items-center">
                <h6>{{ __('All Certified Parents') }}</h6>
            </div>
            <div class="row">
                @if (count($certified_parents) > 0)
                    <div class="col-12">
                        <div class="table-responsive table-responsive-xl">
                            <table class="table">
                                ...
                                <tbody>
                                    @foreach ($certified_parents as $instructor)
                                    {{ $instructor->total }}
                                        <tr>
                                            <td>
                    ...
                    <!-- Pagination Start -->
                    @if (@$certified_parents->hasPages())
                        {{ @$certified_parents->links('frontend.paginate.paginate') }}
                    @endif
                    <!-- Pagination End -->
                @else
