<div class="instructor-profile-left-part bg-white">
    <nav class="account-page-menu">
        <ul>
            <li><a href="{{route('parent.dashboard')}}" class="{{active_if_full_match('instructor/dashboard')}} {{ @$navDashboardActiveClass }}"><span class="iconify mr-15" data-icon="feather:home"></span>{{__('Dashboard')}}</a></li>
            ...
            @if(@auth()->user()->certified_parent->organization_id != NULL)
            <li><a href="{{route('parent.course.organization')}}" class="{{active_if_full_match('instructor/course/organization')}} {{ @$navCourseOrganizationActiveClass }}" ><span class="iconify mr-15" data-icon="ion:log-in-outline"></span>{{__('Organization Courses')}}</a></li>
            @endif
            ...
            <li><a href="{{route('parent.messages')}}" class="{{active_if_full_match('parent/my-messages')}} {{ @$navMessagesActiveClass }}" ><span class="iconify mr-15" data-icon="uil:message"></span>{{__('My Messages')}}</a></li>
            {{-- <li class="menu-has-children current-menu-item {{@$navConsultationActiveClass}}">
                ...
                <ul class="account-sub-menu">
                    <li><a href="{{ route('parent.consultation.dashboard') }}" class="{{@$subNavConsultationDashboardActiveClass}}">{{ __('Dashboard') }}</a></li>
                    <li><a href="{{ route('parent.bookingRequest') }}" class="{{ @$subNavBookingRequestActiveClass }}">{{ __('Booking Request') }}</a></li>
                    <li><a href="{{ route('parent.bookingHistory') }}" class="{{ @$subNavBookingHistoryActiveClass }}">{{ __('Booking History') }}</a></li>
                    <li><a href="{{ route('parent.messages') }}" class="{{ @$subNavBookingHistoryActiveClass }}">{{ __('My Messages') }}</a></li>
                </ul>
            </li> --}}
            ...
            {{-- <li style="display:none;"><a href="{{route('instructor.multi_instructor')ذ}}" class="{{@$navInstructorRequestActiveClass}}" ><span class="iconify mr-15" data-icon="fluent:branch-request-20-regular"></span>{{__('Instructor Request')}}</a></li> --}}
            <li><a href="{{ route('parent.followings') }}" class="{{ @$navFollowingsActiveClass }}" ><span class="iconify mr-15" data-icon="fluent-mdl2:follow-user"></span>{{__('Followings')}}</a></li>
            <li><a href="{{ route('parent.followers') }}" class="{{ @$navFollowersActiveClass }}" ><span class="iconify mr-15" data-icon="fluent-mdl2:user-followed"></span>{{__('Followers')}}</a></li>
            <li class="menu-has-children current-menu-item {{@$navProfileActiveClass}}">
                ...
                <ul class="account-sub-menu">
                    <li><a href="{{ route('parent.profile') }}" class="{{ @$subNavProfileBasicActiveClass }}">{{__('Basic Information')}}</a></li>
                    <li><a href="{{ route('parent.address') }}" class="{{ @$subNavProfileAddressActiveClass }}">{{__('Address & Location')}}</a></li>
                </ul>
            </li>
