                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="75%"
                                ...
                                <tr>
                                    <td align="left">
                                        ...
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                                            We hope this email finds you well. We wanted to inform you that you have
                                            received a new message from {{ $data['sender_name'] }} on
                                            {{ get_option('app_name') }}.
                                        </div>
                                        <div style="height: 20px; line-height: 20px; font-size: 8px;">&nbsp;</div>
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                                            To view the message, simply log in to your account on
                                            {{ get_option('app_name') }} and navigate to your messages. You can also
                                            respond to the message directly through the platform to continue the
                                            conversation.
                                        </div>
                                        ...
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                                            If you have any questions or concerns about the message or the services
                                            provided by {{ $data['sender_name'] }}, please do not hesitate to reach out
                                            to us. Our customer support team is available to assist you with any issues
                                        ...
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                                            Thank you for using {{ get_option('app_name') }} and we hope you find
                                            {{ $data['sender_name'] }}'s message helpful.
                                        </div>
                                        <div style="height: 20px; line-height: 20px; font-size: 8px;">&nbsp;</div>
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="255">
                                <tr>
                                    <td align="center" valign="middle" height="44"
                                        ...
                                        <a href="{{ route('student.messages', ['convo' => $data['conversation_id']]) }}"
