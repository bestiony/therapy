                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item font-14"><a href="{{ route('main.index') }}"><span
                                                        class="iconify" data-icon="bx:home-alt"></span>
                                                    {{ __('Home') }}</a>
                                            </li>
                                            <li class="breadcrumb-item font-14" aria-current="page"><a
                                                    href="{{ route('forum.index') }}">{{ __('Forum') }}</a></li>
                ...
                <div class="row forum-top-row-part">
                    ...
                    <div class="col-xs-12 col-md-10 col-lg-10 col-xl-9">
                        <div class="forum-details-leftside">
                            ...
                            <div class="forum-details-item">
                                    ...
                                    <div class="forum-details-top-right">
                                        <ul class="forum-category-single-item-bottom-right d-flex align-items-center">
                                            <li><span class="iconify"
                                                    data-icon="ant-design:star-outlined"></span>{{ countUserReplies($forumPost->user_id) }}
                                            </li>
                                            <li><span class="iconify"
                                                    data-icon="bi:eye"></span>{{ $forumPost->total_seen }}</li>
                                            <li><span class="iconify"
                                                    data-icon="fluent:comment-24-regular"></span>{{ $forumPost->forumPostComments->count() }}
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <ul class="forum-category-single-item-bottom-left d-flex align-items-center">
                                        <li><span class="iconify"
                                                data-icon="ci:calendar-calendar"></span>{{ @$forumPost->created_at->format(' j  M, Y') }}
                                        </li>
                                    </ul>
                                    @if (@Auth::user())
                                        <ul class="forum-category-single-item-bottom-right d-flex align-items-center">
                                            <li><a href="#reply_answer"
                                                    class="theme-btn theme-button1 theme-button3 reply-btn">{{ __('Reply') }}</a>
                                            </li>
                                        </ul>
                                    @endif
                                </div>
                            ...
                            <div class="replies-wrap scrollspy-example" data-bs-spy="scroll" data-bs-target="#list-example"
                                        ...
                                        <div class="replies-box border-1 radius-4">
                                            ...
                                            <div class="forum-details-item reply-item">
                                                ...
                                                <div class="forum-details-item-top d-flex justify-content-between">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                ...
                                                                @elseif(@$forumPostComment->user->role == 2)
                                                                    <h6>{{ $forumPostComment->user->instructor->name }}
                                                                    </h6>
                                                    ...
                                                    <div class="forum-details-top-right">
                                                        <ul
                                                            ...
                                                            <li><span class="iconify"
                                                                    data-icon="ant-design:star-outlined"></span>{{ countUserReplies($forumPostComment->user_id) }}
                                                            </li>
                                                            <li><span class="iconify"
                                                                    data-icon="fluent:comment-24-regular"></span>{{ $forumPostComment->forumPostCommentReplies->count() }}
                                                            </li>
                                                            @if($forumPostComment->user_id == auth()->id() || $is_admin)
                                                            <li>
                                                                <i class="icon clickable fa fa-ellipsis-h mx-4 "
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    ...
                                                                    <li>
                                                                        <form method="POST" action="{{route('forum.delete-comment',['comment'=>$forumPostComment->id])}}">
                                                                            @csrf
                                                                            <button wire:click='stop_conversation'
                                                                                class="dropdown-item" href="#">{{__('delete comment')}}</button>
                                                                        </form>
                                                                    </li>
                                                ...
                                                <div
                                                    class="forum-details-bottom forum-category-single-item-bottom d-flex justify-content-between">
                                                    <ul
                                                        class="forum-category-single-item-bottom-left d-flex align-items-center">
                                                        <li><span class="iconify"
                                                                data-icon="ci:calendar-calendar"></span>{{ @$forumPostComment->created_at->format(' j  M, Y') }}
                                                        </li>
                                                    </ul>
                                                    @if (@Auth::user())
                                                        <ul
                                                            ...
                                                            <li>
                                                                <button
                                                                    class="theme-btn theme-button1 theme-button3 reply-btn replyBtn"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#commentReplyModal"
                                                                    data-parent_id="{{ $forumPostComment->id }}">{{ __('Reply') }}</button>
                                                            </li>
                                                        </ul>
                                                    @endif
                                                </div>
                                                ...
                                                <div class="forum-details-item reply-item reply-item-inner">
                                                    ...
                                                    <div class="forum-details-item-top d-flex justify-content-between">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="flex-grow-1 ms-3">
                                                                    ...
                                                                    @elseif(@$forumPostCommentReply->user->role == 2)
                                                                        <h6>{{ $forumPostCommentReply->user->instructor->name }}
                                                                        </h6>
                                                                        <p class="font-medium">{{ __('Instructor') }}</p>
                                                                    @elseif(@$forumPostCommentReply->user->role == 3)
                                                                        <h6>{{ $forumPostCommentReply->user->student->name }}
                                                                        </h6>
                                                                        <p class="font-medium">{{ __('Student') }}</p>
                                                                    @else
                                                                        <h6>{{ __('Unknown') }}</h6>
                                                        ...
                                                        <div class="forum-details-top-right">
                                                            <ul
                                                                class="forum-category-single-item-bottom-right d-flex align-items-center">
                                                                <li><span class="iconify"
                                                                        data-icon="ant-design:star-outlined"></span>{{ countUserReplies($forumPostCommentReply->user_id) }}
                                                                </li>
                                                                @if($forumPostCommentReply->user_id == auth()->id() || $is_admin)
                                                            <li>
                                                                <i class="icon clickable fa fa-ellipsis-h mx-4 "
                                                                    aria-hidden="true" data-bs-toggle="dropdown"
                                                                    aria-expanded="false" wire:ignore></i>
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    ...
                                                                    <li>
                                                                        <form method="POST" action="{{route('forum.delete-reply',['reply'=>$forumPostCommentReply->id])}}">
                                                                            @csrf
                                                                            <button wire:click='stop_conversation'
                                                                                class="dropdown-item" href="#">{{__('delete reply')}}</button>
                                                                        </form>
                                                                    </li>
                                                    ...
                                                    <div
                                                        ...
                                                        <ul
                                                            class="forum-category-single-item-bottom-left d-flex align-items-center">
                                                            <li><span class="iconify"
                                                                    data-icon="ci:calendar-calendar"></span>
                            ...
                            @if (@Auth::user())
                                <div class="reply-to-the-topic-box border-1 radius-4 p-30 mt-30" id="reply_answer">
                                    ...
                                    <form action="{{ route('forum.forumPostComment.store') }}" method="post">
                                        ...
                                        <button type="submit"
                                            class="mt-20 theme-btn theme-button1 theme-button3 reply-btn">{{ __('Reply') }}</button>
                                    </form>
                        ...
                        <div class="forum-details-rightside p-30 pt-0 sticky-top">
                            @if (count($forumPostComments) >= 1)
                                <ul class="forum-timeline-menu list-group sticky-top" id="list-example">
                                    <div class="timeline-topic-publish-date position-absolute">
                                        {{ @$forumPost->created_at->format(' j  M, Y') }}</div>

                                    @foreach ($forumPostComments ?? [] as $forumPostComment)
                                        <li><a href="#timeline-menu-item{{ $forumPostComment->id }}"
                                                class="timeline-menu-item list-group-item"><span
                                                    class="timeline-comment-count">{{ $loop->iteration }}/{{ count($forumPostComments) }}</span>{{ @$forumPostComment->created_at->format(' j  M, Y') }}</a>
                                        </li>
                                        @php $lastComment = $forumPostComment; @endphp
                                    @endforeach

                                    @if (isset($lastComment))
                                        <div class="timeline-topic-end-date position-absolute">
                                            {{ @$lastComment->created_at->format(' j  M, Y') }}</div>
                                    @endif
                                </ul>
                            @endif
                        </div>
                                    ...
                                    @foreach ($suggestedForumPosts as $suggestedForumPost)
                                        ...
                                        <div class="forum-category-single-item d-flex border-1 radius-4">
                                            ...
                                            <div class="forum-category-single-item-right flex-grow-1 ms-3">
                                                <p class="font-14 color-hover">
                                                    {{ @$suggestedForumPost->forumCategory->title }}</p>
                                                <h6 class="font-20">{{ $suggestedForumPost->title }}</h6>
                                                <p class="font-15">{!! strip_tags(Str::words($suggestedForumPost->description, 60)) !!}</p>

                                                <div
                                                    class="forum-category-single-item-bottom d-flex justify-content-between">
                                                    <ul
                                                        class="forum-category-single-item-bottom-left d-flex align-items-center">
                                                        @if (@$suggestedForumPost->user->role == 1)
                                                            <li
                                                                class="forum-category-single-item-bottom-left-name font-14 radius-4">
                                                                By
                                                                <a href="#"
                                                                    class="color-heading font-medium ps-2">{{ $suggestedForumPost->user->name }}</a>
                                                            </li>
                                                            <li>{{ __('Admin') }}</li>
                                                        @elseif(@$suggestedForumPost->user->role == 2)
                                                            <li
                                                                ...
                                                                By
                                                                <a href="#"
                                                                    class="color-heading font-medium ps-2">{{ $suggestedForumPost->user->instructor->name }}</a>
                                                            </li>
                                                            <li>{{ __('Instructor') }}</li>
                                                        @elseif(@$suggestedForumPost->user->role == 3)
                                                            <li
                                                                ...
                                                                By
                                                                <a href="#"
                                                                    class="color-heading font-medium ps-2">{{ $suggestedForumPost->user->student->name }}</a>
                                                            </li>
                                                            <li>{{ __('Student') }}</li>
                                                        @endif
                                                        <li><span class="iconify"
                                                                data-icon="ci:calendar-calendar"></span>{{ @$suggestedForumPost->created_at->format(' j  M, Y') }}
                                                        </li>
                                                    </ul>
                                                    <ul
                                                        class="forum-category-single-item-bottom-right d-flex align-items-center">
                                                        <li><span class="iconify"
                                                                data-icon="ant-design:star-outlined"></span>{{ countUserReplies($suggestedForumPost->user_id) }}
                                                        </li>
                                                        <li><span class="iconify"
                                                                data-icon="bi:eye"></span>{{ $suggestedForumPost->total_seen }}
                                                        </li>
                                                        <li><span class="iconify"
                                                                data-icon="fluent:comment-24-regular"></span>{{ $suggestedForumPost->forumPostComments->count() }}
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="blog-item">
                                    ...
                                    <div class="blog-item-bottom-part">
                                        ...
                                        <p class="blog-author-name-publish-date font-13 font-medium color-gray">
                                            {{ $blog->user->name }} / {{ @$blog->created_at->format(' j  M, Y') }}</p>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('forum.forumPostCommentReply.store') }}" method="post">
                    ...
                    <div class="modal-footer d-flex justify-content-between align-items-center">
                        ...
                        <button type="submit"
                            class="theme-btn theme-button1 default-hover-btn">{{ __('Reply') }}</button>
                    </div>
                </form>
            </div>
        </div>
