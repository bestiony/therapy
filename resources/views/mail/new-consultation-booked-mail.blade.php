                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="75%"
                                ...
                                <tr>
                                    <td align="left">
                                        ...
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                                            We hope this email finds you well. We wanted to inform you that
                                            {{ $data['sender_name'] }} has booked a new consultation with you on {{$data['booking']?->date}}
                                            at {{$data['booking']?->time}}.
                                        </div>
                                        <div style="height: 20px; line-height: 20px; font-size: 8px;">&nbsp;</div>
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                                            To view the consultation details, simply log in to your account on
                                            {{ get_option('app_name') }} and navigate to your <a href="{{route("instructor.bookingHistory")}}">consultation history</a>. You can also
                                            start sending messages directly through the platform to start the
                                            conversation.
                                        </div>
                                        ...
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                                            If you have any questions or concerns about the message from
                                            {{ $data['sender_name'] }}, please do not hesitate to reach out to us. Our
                                        ...
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                                            Thank you for using {{ get_option('app_name') }} and we hope you could help
                                            {{ $data['sender_name'] }} with their inquiry.
                                        </div>
                                        <div style="height: 20px; line-height: 20px; font-size: 8px;">&nbsp;</div>
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="255">
                                <tr>
                                    <td align="center" valign="middle" height="44"
                                        ...
                                        <a href="{{ route('instructor.messages', ['convo' => $data['conversation_id']]) }}"
