                ...
                <div class="col-lg-9 col-md-8">
                    <div class="email-inbox__area bg-style form-horizontal__item bg-style admin-general-settings-page">
                        ...
                        <form action="{{route('settings.general_setting.cms.update')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="row input__group mb-25">
                                <label for="allow_preloader" class="col-lg-3">{{__('Registration Phone Number Verification')}} <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <select name="registration_phone_number_verification" class="form-control">
                                        <option value="">{{ __('Select Option') }}</option>
                                        <option value="1" @if(get_option('registration_phone_number_verification') == 1) selected @endif>{{ __('Active') }}</option>
                                        <option value="0" @if(get_option('registration_phone_number_verification') != 1) selected @endif>{{ __('Disable') }}</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row input__group mb-25">
                                <label class="col-lg-3">{{ __('Accept Terms Message') }} <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" name="accept_terms_message" value="{{get_option('accept_terms_message')}}" class="form-control" >
                                </div>
                            </div>
                            <div class="row input__group mb-25">
                            ...
                            <div class="item-top mb-30"><h2>{{ __('Twilio API Keys') }}</h2></div>
                            <div class="row input__group mb-25">
                                <label class="col-lg-3">{{ __('Twilio SID') }} <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" name="twilio_sid" value="{{get_option('TWILIO_SID')}}" class="form-control" >
                                </div>
                            </div>
                            <div class="row input__group mb-25">
                                <label class="col-lg-3">{{ __('Twilio Auth Token') }} <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" name="twilio_auth_token" value="{{get_option('TWILIO_AUTH_TOKEN')}}" class="form-control" >

                                </div>
                            </div>
                            <div class="row input__group mb-25">
                                <label class="col-lg-3">{{ __('Twilio Verify SID') }} <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" name="twilio_verify_sid" value="{{get_option('TWILIO_VERIFY_SID')}}" class="form-control" >
