...
Route::group(['prefix'=>'messages','as'=>'admin.'], function(){
    Route::get('/',[MessagesController::class,'admin_index'])->name('messages');
    Route::post('stop',[MessagesController::class,'therapsit_stop_conversation'])->name('stop-conversation');
    Route::post('resume',[MessagesController::class,'therapsit_resume_conversation'])->name('resume-conversation');
});
