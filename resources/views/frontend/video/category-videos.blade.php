                    ...
                    <div class="page-banner-content text-center">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                ...
                                <li class="breadcrumb-item font-14"><a href="{{ route('videos') }}">{{ __('Videos') }}</a></li>
                ...
                <div class="blog-page-left-content row">
                    ...
                    <div class="blog-item col-md-4">
                        ...
                        <div class="blog-item-bottom-part">
                            <h3 class="card-title blog-title"><a href="{{ route('video-details', $video->slug) }}">{{ __($video->title) }}</a></h3>
                            <p class="blog-author-name-publish-date font-13 font-medium color-gray">{{ __('By') }}: {{ $video->user->name }} / {{ @$video->created_at->format(' j  M, Y')  }}</p>
                            <p class="card-text blog-content">{!!  Str::limit($video->details, 200) !!}</p>

                            <div class="blog-read-more-btn">
                                <a href="{{ route('video-details', $video->slug) }}" class="theme-btn font-15 ps-0 font-medium color-hover">{{ __('Read More') }} <i data-feather="arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- Blog Item End -->
                                ...
                                <div class="sidebar-blog-item d-flex">
                                    <div class="flex-shrink-0">
                                        <div class="sidebar-blog-item-img-wrap overflow-hidden">
                                            <a href="{{ route('video-details', $recentVideo->slug) }}"><img src="{{ getImageFile($recentVideo->image_path) }}" alt="img" class="img-fluid"></a>
                                        </div>
                                    </div>
