<div wire:ignore.self class="modal fade edit_modal" id="editLecture" tabindex="-1" aria-labelledby="editLectureLabel"
    aria-hidden="true">
                                ...
                                <div id="msform">
                                    ...
                                    <div class="upload-course-step-item upload-course-overview-step-item">
                                        ...
                                        <div class="upload-course-step-item upload-course-video-step-item">
                                            <form wire:submit.prevent='updateLecture' {{-- method="POST" --}}
                                                ...
                                                <div id="upload-course-video-4">
                                                    <div
                                                                    ...
                                                                    <div class="upload-img-box mt-3 height-200">
                                                                        @if ($image)
                                                                            <img src="{{ $image->temporaryUrl() }}"
                                                                                class="w-50 h-auto">
                                                                        @elseif($lecture?->image)
                                                                            <img src="{{ asset($lecture->image) }}"
                                                                                alt="upload">
                                                                        @else
                                                                            <img src="{{ asset('frontend/assets/img/instructor-img/upload-lesson-icon.png') }}"
                                                                                alt="upload">
                                                        ...
                                                        <div id="slide_documentDiv"
                                                            class="{{ $type == 'slide_document' ? '' : 'd-none' }}">
                                                            <label
