...
use App\Http\Controllers\Parent\DiscussionController;
use App\Http\Controllers\Parent\ExamController;
use App\Http\Controllers\Parent\FinanceController;
use App\Http\Controllers\Parent\LessonController;
use App\Http\Controllers\Parent\LiveClassController;
use App\Http\Controllers\Parent\NoticeBoardController;
...
use App\Http\Controllers\Parent\GmeetSettingController;
use App\Http\Controllers\Parent\MultiParentController;
use App\Http\Controllers\Parent\ScormController;
use App\Http\Controllers\Parent\ZoomSettingController;
use App\Http\Controllers\MessagesController;
use Illuminate\Support\Facades\Route;

Route::get('dashboard', [DashboardController::class, 'dashboard'])->name('parent.dashboard');
// Route::get('ranking-level-list', [DashboardController::class, 'rankingLevelList'])->name('parent.ranking-level');
...
Route::get('create', [CourseController::class, 'create'])->name('parent.course.create');
Route::prefix('course')->group(function () {
    Route::get('/', [CourseController::class, 'index'])->name('parent.course');
    Route::get('/organization', [CourseController::class, 'organizationCourses'])->name('parent.course.organization');
    Route::post('store', [CourseController::class, 'store'])->name('parent.course.store')->middleware('isDemo');
    Route::get('edit/{uuid}', [CourseController::class, 'edit'])->name('parent.course.edit');
    ...
    Route::get('get-subcategory-by-category/{category_id}', [CourseController::class, 'getSubcategoryByCategory'])->withoutMiddleware('parent');
    Route::delete('course-delete/{uuid}', [CourseController::class, 'delete'])->name('parent.course.delete')->middleware('isDemo');
    ...
    Route::post('store-parent/{course_uuid}', [CourseController::class, 'storeParent'])->name('course.store.parent')->middleware('isDemo');
...
Route::group(['prefix' => 'bundle', 'as' => 'parent.'], function () {
...
Route::prefix('account')->group(function () {
    Route::group(['prefix' => 'accounts'], function () {
        Route::get('my-card', [AccountController::class, 'myCard'])->name('parent.my-card');
        Route::post('save-my-card', [AccountController::class, 'saveMyCard'])->name('parent.save.my-card')->middleware('isDemo');
        Route::post('save-paypal', [AccountController::class, 'savePaypal'])->name('parent.save.paypal')->middleware('isDemo');
    });
});

Route::group(['prefix' => 'certificates', 'as' => 'parent.'], function () {
...
Route::post('parent-reply-discussion/{discussion_id}', [DiscussionController::class, 'parentCourseDiscussionReply'])->name('parent-discussion.reply')->middleware('isDemo');

Route::get('all-enroll', [StudentController::class, 'allStudentIndex'])->name('parent.all-student');
...
Route::name('parent.')->group(function () {
    ...
    Route::get('course-parent-request', [MultiParentController::class, 'index'])->name('multi_parent');
    Route::post('course-parent-request/{id}', [MultiParentController::class, 'changeStatus'])->name('multi_parent.change_status')->middleware('isDemo');
