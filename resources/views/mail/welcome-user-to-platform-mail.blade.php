                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="75%"
                                ...
                                <tr>
                                    <td align="left">
                                        ...
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                                            We are delighted to welcome you to my-therapists.com, the ultimate platform
                                            for mental health. We are thrilled to have you as a member of our community!
                                        </div>
                                        <div style="height: 20px; line-height: 20px; font-size: 8px;">&nbsp;</div>
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                                            As a registered user, you now have access to all of the amazing features
                                            that our platform offers. We are confident that you will find everything you
                                            need to make the most of your time on our platform.
                                        </div>
                                        <div style="height: 20px; line-height: 20px; font-size: 8px;">&nbsp;</div>
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                                            At my-therapists.com, we are committed to providing the best possible
                                            experience for our users. That's why we offer a variety of resources and
                                            support to help you navigate the platform and connect with other users. You
                                            can also find useful information and tips on our blog, which we highly
                                        ...
                                        <div class="Inter400"
                                            ...
                                            us. Our friendly customer support team is available 24/7 to assist you with
                                            any issues you may encounter.
                                        </div>
                                        <div style="height: 20px; line-height: 20px; font-size: 8px;">&nbsp;</div>
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                                            Thank you for choosing [Platform Name]! We are excited to have you as part
                                            of our community and look forward to seeing you on the platform.
                                        </div>
                                        <div style="height: 20px; line-height: 20px; font-size: 8px;">&nbsp;</div>
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="255">
                                <tr>
                                    <td align="center" valign="middle" height="44"
                                        ...
                                        <a href="{{ route('main.index') }}" class="Inter700" target="_blank"
