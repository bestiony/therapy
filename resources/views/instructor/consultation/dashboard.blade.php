                ...
                <form action="{{ route('instructor.consultation.instructorAvailabilityStoreUpdate') }}" method="post">
                    ...
                    <div class="mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" @if ($instructor->consultation_available == 1) checked @endif type="radio"
                    ...
                    <div class="mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" @if ($instructor->available_type == 1) checked @endif type="radio"
                                id="inlineCheckbox3" value="1" name="available_type">
                            <label class="form-check-label color-heading mb-0"
                                for="inlineCheckbox3">{{ __('In Person') }}</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" @if ($instructor->available_type == 2) checked @endif type="radio"
                                id="inlineCheckbox4" value="2" name="available_type">
                            <label class="form-check-label color-heading mb-0"
                                for="inlineCheckbox4">{{ __('Online') }}</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" @if ($instructor->available_type == 3) checked @endif type="radio"
                    ...
                    <div class="mb-3 row instructor-panel-monthly-rate-box align-items-center">
                        ...
                        <div class="col-sm-6 col-md-3">
                            <input type="text" step="any" min="0" name="availibity_range" class="form-control"
                                id="bookingNote" placeholder="" value="{{ $instructor->availibity_range }}">
                        </div>
                    ...
                    <div id="consultancyArea" class="@if ($instructor->available_type == 2) d-none @endif">
                        ...
                        <div class="mb-3">
                            @foreach (CONSULTANCY_AREA_ARRAY as $key => $consultancyArea)
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" @if ($instructor->consultancy_area == $key) checked @endif
                    ...
                    <div class="mb-3 row instructor-panel-hourly-rate-box align-items-center">
                        ...
                        <div class="col-sm-6 col-md-3">
                            <input type="number" step="any" min="0" name="hourly_rate" class="form-control"
                                id="hourlyRate" placeholder="Ex.20" value="{{ $instructor->hourly_rate }}">
                        </div>
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" id="offlineStatus" name="is_offline"
                                value="1" {{ $instructor->is_offline == INSTRUCTOR_IS_OFFLINE ? 'checked' : '' }}>
                            <label class="form-check-label color-heading mb-0"
                                for="offlineStatus">{{ __('Offline Status') }}</label>
                        </div>
                        <div class="mb-3 {{ $instructor->is_offline == INSTRUCTOR_IS_OFFLINE ? '' : 'd-none' }}"
                            id="offlineMessage">
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" id="isSubscriptionEnable"
                                ...
                                {{ $instructor->is_subscription_enable == STATUS_ACCEPTED ? 'checked' : '' }}>
                            <label class="form-check-label color-heading mb-0"
                                    ...
                                    <td>
                                        <div class="notice-board-action-btns">
                                            ...
                                            <button type="button"
                                                ...
                                                data-route="{{ route('instructor.consultation.slotView', 6) }}"
                                                data-bs-toggle="modal"
                                    ...
                                    <td>
                                        <div class="notice-board-action-btns">
                                            ...
                                            <button type="button"
                                                ...
                                                data-route="{{ route('instructor.consultation.slotView', 0) }}"
                                                data-bs-toggle="modal"
                                                data-bs-target="#viewSlotModal">{{ __('View') }}
                                            </button>
                                        </div>
                                    ...
                                    <td>
                                        <div class="notice-board-action-btns">
                                            ...
                                            <button type="button"
                                                ...
                                                data-route="{{ route('instructor.consultation.slotView', 1) }}"
                                                data-bs-toggle="modal"
                                                data-bs-target="#viewSlotModal">{{ __('View') }}
                                            </button>
                                        </div>
                                    ...
                                    <td>
                                        <div class="notice-board-action-btns">
                                            ...
                                            <button type="button"
                                                ...
                                                data-route="{{ route('instructor.consultation.slotView', 2) }}"
                                                data-bs-toggle="modal"
                                                data-bs-target="#viewSlotModal">{{ __('View') }}
                                            </button>
                                        </div>
                                    ...
                                    <td>
                                        <div class="notice-board-action-btns">
                                            ...
                                            <button type="button"
                                                ...
                                                data-route="{{ route('instructor.consultation.slotView', 3) }}"
                                                data-bs-toggle="modal"
                                                data-bs-target="#viewSlotModal">{{ __('View') }}
                                            </button>
                                        </div>
                                    ...
                                    <td>
                                        <div class="notice-board-action-btns">
                                            ...
                                            <button type="button"
                                                ...
                                                data-route="{{ route('instructor.consultation.slotView', 4) }}"
                                                data-bs-toggle="modal"
                                                data-bs-target="#viewSlotModal">{{ __('View') }}
                                            </button>
                                        </div>
                                    ...
                                    <td>
                                        <div class="notice-board-action-btns">
                                            ...
                                            <button type="button"
                                                ...
                                                data-route="{{ route('instructor.consultation.slotView', 5) }}"
                                                data-bs-toggle="modal"
                                                data-bs-target="#viewSlotModal">{{ __('View') }}
                                            </button>
                                        </div>
