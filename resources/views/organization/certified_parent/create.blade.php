...
@section('content')
    <div class="instructor-profile-right-part">
        <form method="POST" action="{{ route('organization.certified_parent.store') }}" enctype="multipart/form-data"
            autocomplete="off">
            @csrf
            <div class="instructor-profile-info-box">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-30">
                        ...
                        <select name="user_category_id" id="country_id" class="form-select" required>
