...
class SupportTicketController extends Controller
{
    ...
    {
        if (Auth::user()->role != USER_ROLE_ORGANIZATION) {
            abort('403');
        } // end permission checking

        $data['title'] = 'Support Ticket List';
        $data['navSupportTicketParentActiveClass'] = 'has-open';
        $data['subNavSupportTicketIndexActiveClass'] = 'active';
        $data['tickets'] = Ticket::where('organization_user_id',auth()->id())->paginate(25);

        return view('organization.support_ticket.index', $data);
    }
    ...
    public function ticketShow($uuid)
    {
        ...
        $user = auth()->user();
        if ($user->id != $data['ticket']->organization_user_id || $user->role != USER_ROLE_ORGANIZATION ) {
            abort('403');
        }
        //end permission checking
        ...
        $data['user'] = $user;
        return view('organization.support_ticket.details', $data);
    }
    ...
    public function Department()
    {
        ...
        return view('organization.application_settings.support_ticket.ticket-department-list', $data);
    }
    ...
    public function Priority()
    {
        ...
        return view('organization.application_settings.support_ticket.ticket-priority-list', $data);
    }
    ...
    public function RelatedService()
    {
        ...
        return view('organization.application_settings.support_ticket.ticket-related-service-list', $data);
    }
