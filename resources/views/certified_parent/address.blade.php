...
@section('content')
    <div class="instructor-profile-right-part">
        <form method="POST" action="{{ route('parent.address.update', [$certified_parent->uuid]) }}"
            ...
            <div class="instructor-profile-info-box">
                        ...
                        <select name="country_id" id="country_id" class="form-select">
                            ...
                            @foreach ($countries as $country)
                                <option value="{{ $country->id }}"
                                    ...
                                    @else
                                    {{ $certified_parent->country_id == $country->id ? 'selected' : '' }} @endif
                ...
                <div class="row">
                    <div class="col-md-4 mb-30">
                        ...
                        <select name="state_id" id="state_id" class="form-select">
                            ...
                            @if (old('country_id'))
                                ...
                                @endforeach
                            @else
                                @if ($certified_parent->country)
                                    @foreach ($certified_parent->country->states as $selected_state)
                                        <option value="{{ $selected_state->id }}"
                                            {{ $certified_parent->state_id == $selected_state->id ? 'selected' : '' }}
                    ...
                    <div class="col-md-4 mb-30">
                        ...
                        <select name="city_id" id="city_id" class="form-select">
                            ...
                            @if (old('state_id'))
                                ...
                                @endforeach
                            @else
                                @if ($certified_parent->state)
                                    @foreach ($certified_parent->state->cities as $selected_city)
                                        <option value="{{ $selected_city->id }}"
                                            {{ $certified_parent->city_id == $selected_city->id ? 'selected' : '' }}
                    ...
                    <div class="col-md-4 mb-30">
                        ...
                        <input type="text" name="postal_code" value="{{ $certified_parent->postal_code }}"
                ...
                <div class="row">
                    <div class="col-md-12 mb-30">
                        ...
                        <input type="text" name="address" value="{{ $certified_parent->address }}" class="form-control"
