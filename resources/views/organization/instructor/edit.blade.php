        ...
        <form method="POST" action="{{ route('organization.instructor.update', $instructor->uuid) }}"
            ...
            <div class="instructor-profile-info-box">
                ...
                <div class="row">
                        ...
                        <select class="form-control" name="area_code">
                            ...
                            @foreach ($countries as $country)
                                <option value="{{ $country->phonecode }}"
                                    @if ($instructor->user->area_code == $country->phonecode)
                                    selected
                                    @endif>
                    ...
                    <div class="col-md-6 mb-30">
                        <label class="font-medium font-15 color-heading">{{ __('Category') }}</label>
                        <select name="user_category_id" id="category_id" class="form-select">
                            <option value="">{{ __('Select Category') }}</option>
                            @foreach ($categories as $category)
                                <option value="{{ $category->id }}"
                                    @if ($instructor->user_category_id)
                                    {{ $instructor->user_category_id == $category->id ? 'selected' : '' }}
                                    @endif>
