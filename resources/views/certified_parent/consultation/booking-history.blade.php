                                ...
                                <table class="table booking-history-upcoming-table">
                                    ...
                                    @foreach($bookingHistoryUpcoming as $upcoming)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="red-blue-action-btns text-center">
                                                ...
                                                @if($upcoming->order->conversation)
                                                <div class="red-blue-action-btns text-center">
                                                    <button type="button"
                                                        data-route="{{ route('instructor.messages', ['convo'=>$upcoming->order->conversation->id]) }}"
                                                        class="theme-btn btn btn-success default-hover-btn joinChat ">{{ __('Join Chat') }}</button>
                                                </div>
                                                @endif
                                            </td>
                                        </tr>
