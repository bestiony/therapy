            ...
            <div class="modal-content">
                ...
                <form method="POST" action="{{route('student.save-instructor-info')}}" class="needs-validation" novalidate enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-30">
                            <div class="col-md-12">
                                <label class="label-text-title color-heading font-medium font-16 mb-2">{{__('Category')}}</label>
                            ...
                            @if ($errors->has('user_category_id'))
                                <span class="text-danger"><i class="fas fa-exclamation-triangle"></i> {{ $errors->first('user_category_id') }}</span>
                            @endif
                        </div>
