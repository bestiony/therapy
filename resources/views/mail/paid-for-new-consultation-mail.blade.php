                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="75%"
                                ...
                                <tr>
                                    <td align="left">
                                        ...
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                                            We are excited to have you as a client for our consultation services. Thank
                                            you for your recent payment! We appreciate your trust in us and we are
                                        ...
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                                            As a reminder, your payment grants you access to a one-time consultation
                                            with our team of experts. We will work with you to provide personalized
                                            guidance and advice .We are confident that our expertise and experience will
                                            help you achieve your goals.
                                        </div>
                                        <div style="height: 20px; line-height: 20px; font-size: 8px;">&nbsp;</div>
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                                            If you have any questions or concerns about the consultation process or the
