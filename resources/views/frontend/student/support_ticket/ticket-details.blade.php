                            ...
                            <div class="page-banner-content text-center">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb justify-content-center">
                                        ...
                                        <li class="breadcrumb-item font-14"><a
                                                href="{{ url('/') }}">{{ __('Support Tickets') }}</a></li>
                                        <li class="breadcrumb-item font-14"><a
                                                href="{{ route('student.support-ticket.create') }}">{{ __('View Ticket') }}</a>
                                        </li>
                                        <li class="breadcrumb-item font-14 active" aria-current="page">
                                            {{ __('Ticket Details') }}</li>
                                    </ol>
                                </nav>
                                <!-- Breadcrumb End-->
                            </div>
                                ...
                                <div class="col-12 col-md-12 col-lg-8 col-xl-8">
                                    <div class="ticket-details-left-part">
                                        ...
                                        <div class="ticket-details-reply-form-box ticket-details-box radius-4 p-20">
                                            ...
                                            <form action="{{ route('student.support-ticket.message.store') }}"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 mb-20">
                                                        ...
                                                        @endif
                                                        <p class="font-14 placeholder-color">{{ __('Valid file type') }} :
                                                            jpg, jpeg, gif, png and File size max : 10 MB</p>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="ticket-details-right-part ticket-details-box radius-4 p-20">
                                        ...
                                        <div
                                            ...
                                            <div class="ticket-info-right-status d-flex align-items-center">
                                                ...
                                                @if ($ticket->status == 1)
                                                    <div class="ticket-status-box radius-3 bg-green text-white font-14">
                                                        {{ __('Open') }}</div>
