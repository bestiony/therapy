                        ...
                        <div id="msform">
                            ...
                            <div class="upload-course-step-item upload-course-overview-step-item">
                                ...
                                <div class="upload-course-step-item upload-course-video-step-item">
                                    <form method="POST"
                                        action="{{ route('organization.store.lecture', [$course->uuid, $lesson->uuid]) }}"
                                            ...
                                            <div class="upload-course-item-block course-overview-step1 radius-8">
                                                ...
                                                <div id="video">
                                                    ...
                                                    <div
                                                        ...
                                                        <input type="file" name="video_file" accept="video/mp4"
                                                            class="form-control" value="{{ old('video_file') }}"
                                                            id="video_file" title="{{ __('Upload lesson') }}" required>
                                                    </div>
                                                ...
                                                <div id="youtube" class="d-none">
                                                    ...
                                                    <input type="text" name="youtube_url_path"
                                                        ...
                                                        value="{{ old('youtube_url_path') }}" id="youtube_url_path"
                                                    ...
                                                    <div class="row mb-30">
                                                        <div class="col-md-12">
                                                            ...
                                                            <select name="vimeo_upload_type"
                                                                ...
                                                                <option value="1"
                                                                    @if (old('vimeo_upload_type') == 1) selected @endif>
                                                                    {{ __('Video File Upload') }}</option>
                                                                <option value="2"
                                                                    @if (old('vimeo_upload_type') == 2) selected @endif>
                                                    ...
                                                    <div class="vimeo_Video_file_upload_div d-none">
                                                        ...
                                                        <div
                                                            ...
                                                            <input type="file" name="vimeo_url_path"
                                                                ...
                                                                value="{{ old('vimeo_url_path') }}" id="vimeo_url_path"
                                                                title="Upload lesson">
                                                        </div>
                                                ...
                                                <div id="pdfDiv" class="d-none">
                                                    ...
                                                    <div
                                                        ...
                                                        <input type="file" name="pdf" accept="application/pdf"
                                                            class="form-control" value="{{ old('pdf') }}"
                                                            ...
                                                            <div class="row mb-30">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <input type="text" name="title"
                                                                        ...
                                                                        placeholder="{{ __('First steps') }}" required>
                                                                </div>
                                                            </div>
                                                            <div class="row mb-30">
                                                                <div class="col-md-12">
