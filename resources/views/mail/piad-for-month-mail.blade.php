                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="75%"
                                ...
                                <tr>
                                    <td align="left">
                                        ...
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                                            We are delighted to have you as a client for our monthly follow-up services.
                                            Thank you for your recent payment! We appreciate your trust in us and we are
                                            committed to providing you with the best possible experience on our
                                            platform.
                                        </div>
                                        <div style="height: 20px; line-height: 20px; font-size: 8px;">&nbsp;</div>
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                                            As a reminder, your payment grants you access to monthly follow-up sessions
                                            with our team of experts. We will work with you to provide personalized
                                            guidance and support . We are confident that our expertise and experience
                                            will help you achieve your goals.
                                        </div>
                                        <div style="height: 20px; line-height: 20px; font-size: 8px;">&nbsp;</div>
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                                            If you have any questions or concerns about the follow-up process or the
                                            services you have purchased, please do not hesitate to reach out to us. Our
                                            customer support team is available to assist you with any issues or
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="255">
                                <tr>
                                    <td align="center" valign="middle" height="44"
                                        ...
                                        <a href="{{ route('student.my-consultation') }}" class="Inter700"
                                            target="_blank"
