                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="75%"
                                ...
                                <tr>
                                    <td align="left">
                                        ...
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                                            I hope this email finds you well. I am writing to inform you that we have
                                            sent a new message in your support tickets on our online platform.
                                        </div>
                                        <div style="height: 20px; line-height: 20px; font-size: 8px;">&nbsp;</div>
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                                            We understand that your time is valuable, and we want to make sure that you
                                            have all the information you need to address any concerns you may have.
                                            Therefore, we kindly request you to log in to our platform to view the new
                                            message and take any necessary actions.
                                        </div>

                                        <div style="height: 20px; line-height: 20px; font-size: 8px;">&nbsp;</div>
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                                            If you have any trouble accessing the platform or have any questions
                                            regarding the new message, please do not hesitate to contact us. We are
                                        ...
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                                            Thank you for choosing our services, and we appreciate your continued
                                            support. We look forward to hearing back from you soon.
                                        </div>
                                        <div style="height: 20px; line-height: 20px; font-size: 8px;">&nbsp;</div>
                                        <div class="Inter400"
                                            style="font-family: Arial, sans-serif; color: #171717; font-size: 15px; line-height: 21px;">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="255">
                                <tr>
                                    <td align="center" valign="middle" height="44"
                                        ...
                                        <a href="{{ $data['target_url'] }}" class="Inter700" target="_blank"
