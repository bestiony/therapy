<div class="sidebar__area">
    ...
    <ul id="sidebar-menu" class="sidebar__menu" style="background-color:#470a6e;">
        ...
        @canany(['manage_course_reference', 'manage_course_category', 'manage_course_subcategory', 'manage_course_tag', 'manage_course_language', 'manage_course_difficulty_level'])
            <li class="{{ @$navCourseActiveClass }}">
                <a class="has-arrow" href="#">
                    ...
                    <span>Tutourails Reference</span>
                </a>
                <ul>
        ...
        @can('manage_student')
            <li class=" {{ active_if_full_match('admin/student') }} ">
                ...
                <ul>
                    ...
                    <li class="{{ active_if_match('admin/messages') }}">
                        <a href="{{route('admin.messages')}}">
                            <i class="fa fa-circle"></i>
                            <span>{{ __('Students Messages') }}</span>
                        </a>
                    </li>
                </ul>
            </li>
        ...
        <li style="display:none;" class="{{ @$navMenuParentActiveClass }}">
            <a class="has-arrow" href="#">
        ...
        @can('manage_version_update')
            <li style="display:none;" class="{{ @$subNavVersionUpdateActiveClass }}">
