                        ...
                        <div id="msform">
                            ...
                            <div class="upload-course-step-item upload-course-overview-step-item">
                                ...
                                <div class="upload-course-step-item upload-course-video-step-item">
                                    <form method="POST"
                                        action="{{ route('organization.update.lecture', [$lecture->uuid]) }}"
                                        ...
                                        <div id="upload-course-video-4">
                                            <div class="upload-course-item-block course-overview-step1 radius-8">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="d-flex">
                                                            <div
                                                                ...
                                                                Type: </div>
                                                            <div>
                                                                <label class="mr-15"><input type="radio" name="type"
                                                                        value="video"
                                                                        {{ $lecture->type == 'video' ? 'checked' : '' }}
                                                                        class="lecture-type"> Upload Video</label>
                                                                <label class="mr-15"><input type="radio" name="type"
                                                                        value="youtube"
                                                                        {{ $lecture->type == 'youtube' ? 'checked' : '' }}
                                                                        class="lecture-type"> Youtube </label>
                                                                <label class="mr-15"><input type="radio" name="type"
                                                                        value="vimeo"
                                                                        {{ $lecture->type == 'vimeo' ? 'checked' : '' }}
                                                                        class="lecture-type"> Vimeo</label>
                                                                <label class="mr-15"><input type="radio" name="type"
                                                                        value="text"
                                                                        {{ $lecture->type == 'text' ? 'checked' : '' }}
                                                                        class="lecture-type" id="lectureTypeText"> Text
                                                                </label>
                                                                <label class="mr-15"><input type="radio" name="type"
                                                                        value="image"
                                                                        {{ $lecture->type == 'image' ? 'checked' : '' }}
                                                                        class="lecture-type" id="lectureTypeImage"> Image
                                                                </label>
                                                                <label class="mr-15"><input type="radio" name="type"
                                                                        value="pdf"
                                                                        {{ $lecture->type == 'pdf' ? 'checked' : '' }}
                                                                        class="lecture-type" id="lectureTypePDF"> PDF
                                                                </label>
                                                                <label class="mr-15"><input type="radio" name="type"
                                                                        value="slide_document"
                                                                        {{ $lecture->type == 'slide_document' ? 'checked' : '' }}
                                                                        class="lecture-type" id="lectureTypeSlideDocument">
                                                                    Slide Document </label>
                                                                <label class="mr-15"><input type="radio" name="type"
                                                                        value="audio"
                                                                        {{ $lecture->type == 'audio' ? 'checked' : '' }}
                                                                        class="lecture-type" id="lectureTypeAudio"> Audio
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div id="video"
                                                    class="{{ $lecture->type == 'video' ? '' : 'd-none' }}">
                                                    <div
                                                        ...
                                                        <input type="hidden" id="file_duration" name="file_duration"
                                                            value="{{ $lecture->file_duration }}">
                                                        <input type="file" name="video_file" accept="video/mp4"
                                                            class="form-control" id="video_file" title="Upload lesson">
                                                    </div>

                                                    <p class="font-14 color-gray text-center mt-3 pb-30">
                                                        {{ __('No file selected') }} (MP4 or WMV)</p>
                                                ...
                                                <div id="youtube"
                                                    class="{{ $lecture->type == 'youtube' ? '' : 'd-none' }}">
                                                    <input type="text" name="youtube_url_path" id="youtube_url_path"
                                                        value="{{ $lecture->type == 'youtube' ? $lecture->url_path : '' }}"
                                                        class="form-control youtube-url"
                                                        placeholder="Type Your Youtube Video ID">
                                                    @if ($errors->has('youtube_url_path'))
                                                        <span class="text-danger"><i
                                                                class="fas fa-exclamation-triangle"></i>
                                                            {{ $errors->first('youtube_url_path') }}</span>
                                                    @endif
                                                </div>

                                                <div id="vimeo"
                                                    class="{{ $lecture->type == 'vimeo' ? '' : 'd-none' }}">
                                                    <div class="row mb-30">
                                                        <div class="col-md-12">
                                                            <label
                                                            ...
                                                            <select name="vimeo_upload_type"
                                                                ...
                                                                <option value="1"
                                                                    {{ $lecture->vimeo_upload_type == 1 ? 'selected' : '' }}>
                                                                    {{ __('Video File Upload') }}</option>
                                                                <option value="2"
                                                                    {{ $lecture->vimeo_upload_type == 2 ? 'selected' : '' }}>
                                                                    {{ __('Vimeo Uploaded Video ID') }}</option>
                                                            </select>
                                                        </div>
                                                        @if ($errors->has('vimeo_upload_type'))
                                                            <span class="text-danger"><i
                                                                    class="fas fa-exclamation-triangle"></i>
                                                                {{ $errors->first('vimeo_upload_type') }}</span>
                                                        @endif
                                                    </div>
                                                    <div
                                                        class="vimeo_Video_file_upload_div {{ $lecture->vimeo_upload_type == 1 ? '' : 'd-none' }}">
                                                        <label
                                                    ...
                                                    <div
                                                        class="vimeo_uploaded_Video_id_div {{ $lecture->vimeo_upload_type == 2 ? '' : 'd-none' }}">
                                                        <div class="row mb-30">
                                                            <div class="col-md-12">
                                                                <label
                                                                ...
                                                                <div
                                                                    class="upload-course-video-4-wrap upload-introduction-box-content-left d-flex align-items-center flex-column">
                                                                    <input type="text" name="vimeo_url_uploaded_path"
                                                                        placeholder="Type your uploaded video ID (ex: 123654)"
                                                                        class="form-control"
                                                                        value="{{ $lecture->url_path }}"
                                                        ...
                                                        <div class="row mb-30">
                                                            <div class="col-md-12">
                                                                <label
                                                                    ...
                                                                    (00:00) <span class="text-danger">*</span></label>
                                                                <input type="text" name="vimeo_file_duration"
                                                                    value="{{ $lecture->file_duration }}"
                                                                    class="form-control customVimeoFileDuration"
                                                                    placeholder="Type file duration">
                                                ...
                                                <div id="text"
                                                    class="{{ $lecture->type == 'text' ? '' : 'd-none' }}">
                                                    <label
                                                ...
                                                <div id="imageDiv"
                                                    class="{{ $lecture->type == 'image' ? '' : 'd-none' }}">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-md-6 mb-30">
                                                            ...
                                                            <p class="font-14 color-gray">{{ __('Preferable filetype') }}:
                                                                jpg, jpeg, png</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div id="pdfDiv"
                                                    ...
                                                    <div
                                                        ...
                                                        <input type="file" name="pdf" accept="application/pdf"
                                                            class="form-control" value="" id="pdf"
                                                            title="Upload lesson pdf">
                                                    </div>
                                                </div>
                                                <div id="slide_documentDiv"
                                                    class="{{ $lecture->type == 'slide_document' ? '' : 'd-none' }}">
                                                    <label
                                                        class="label-text-title color-heading font-medium font-16 mb-3">{{ __('Write Your Slide Embed Code') }}
                                                        <span class="text-danger">*</span></label>
                                                    <input type="text" name="slide_document" class="form-control"
                                                        value="{{ $lecture->slide_document }}" id="powerpoint"
                                                        title="Upload lesson slide_document">
                                                </div>
                                                <div id="audioDiv"
                                                    class="{{ $lecture->type == 'audio' ? '' : 'd-none' }}">
                                                    <label
                                                    ...
                                                    <div
                                                        ...
                                                        <input type="file" name="audio" class="form-control"
                                                            value="" id="audio" title="Upload lesson audio">
                                                    </div>
                                                </div>
                                                <div>
                                                    ...
                                                    <div class="d-flex main-upload-video-processing-item">
                                                        <div class="flex-grow-1 ms-3">
                                                            <div class="row mb-30">
                                                                <div class="col-md-12">
                                                                    <label
                                                                        class="label-text-title color-heading font-medium font-16 mb-3">{{ __('Lesson Title') }}</label>
                                                                    <input type="text" name="title"
                                                                        value="{{ $lecture->title }}"
                                                                        class="form-control" placeholder="First steps"
                                                                        required>
                                                                </div>
                                                            </div>
                                                            <div class="row mb-30">
                                                                <div class="col-md-12">
                                                                    <label
                                                                        class="label-text-title color-heading font-medium font-16 mb-3">{{ __('Learners Visibility') }}</label>
                                                                    <select name="lecture_type" class="form-select"
                                                                        required>
                                                                        <option value="">
                                                                            --{{ __('Select Option') }}--</option>
                                                                        <option value="1"
                                                                            @if ($lecture->lecture_type == 1) selected @endif>
                                                                            {{ __('Show') }}</option>
                                                                        <option value="2"
                                                                            @if ($lecture->lecture_type == 2) selected @endif>
                                                                            {{ __('Lock') }}</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="row mb-30 d-none" id="fileDuration">
                                                                <div class="col-md-12">
                                                                    <label
                                                                        class="label-text-title color-heading font-medium font-16 mb-3">{{ __('Lesson File Duration') }}
                                                                        (00:00)</label>
                                                                    <input type="text" name="youtube_file_duration"
                                                                        value="{{ $lecture->file_duration }}"
                                                                        class="form-control customFileDuration"
                                                                        placeholder="First file duration">
                                                                            ...
                                                                            @foreach ($lessons as $pr_lesson)
                                                                                <optgroup label="{{ $pr_lesson->name }}">
                                                                                    @foreach ($pr_lesson->lectures as $pr_lecture)
                                                                                        <option
                                                                                            value="{{ $pr_lecture->id }}"
                                                                                            {{ in_array($pr_lecture->id, $pre_ids) ? 'selected' : '' }}>
                                                                                            {{ $pr_lecture->title }}
                                                                                        </option>
                                                                                    @endforeach
                                                                                </optgroup>
