...
class LessonController extends Controller
{
    ...
    public function storeLecture(Request $request, $course_uuid, $lesson_uuid)
    {
        ...
        return redirect(route('organization.course.edit', $data));
    }
    ...
    public function updateLecture(Request $request,  $lecture_uuid)
    {
        ...
        return redirect(route('organization.course.edit', [($lecture->course ? $lecture->course->uuid : ($course_version ? $course_version->course->uuid : '')), 'step=lesson', 'course_version_id' => $course_version_id]));
    }
