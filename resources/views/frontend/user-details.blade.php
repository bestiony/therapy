                            ...
                            <div class="page-banner-content text-center">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb justify-content-center">
                                        ...
                                        <li class="breadcrumb-item font-14 active" aria-current="page">{{ $pageTitle }}
                                        </li>
                                    </ol>
                                </nav>
                                <!-- Breadcrumb End-->
                        ...
                        <div class="instructor-details-left-content">
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1 me-3">
                                            <h6 class="text-white font-17">
                                                {{ __('Instructor is temporarily unavailable') }}.
                                            </h6>
                                            <p class="text-white font-15 mt-1">
                            ...
                            <div class="instructor-details-left-inner-box about-skills-box bg-white radius-3">
                                ...
                                <div class="about-instructor-box">
                                    <h5 class="instructor-details-inner-title">{{ __('About') }}
                                        {{ @$user->name }}</h5>
                                    ...
                                    <ul class="instructor-skills-tag d-inline-flex align-items-center flex-wrap">
                                        @forelse ($user->$userRelation->skills as $skill)
                                            <li class="bg-page instructor-skills-tag-item">
                                                {{ $skill->title }}</li>
                                        @empty
                                            <li class="font-15"><span class="color-gray2">{{ __('No skills to show') }}
                                            </li>
                                        @endforelse
                                    </ul>
                                </div>
                                    ...
                                    <ul class="instructor-skills-tag d-inline-flex align-items-center flex-wrap">
                                        @forelse ($user_langauges as $language)
                                            <li class="bg-page instructor-skills-tag-item">
                                                {{ $language }}</li>
                                        @empty
                                            <li class="font-15"><span class="color-gray2">{{ __('No Languages to show') }}
                                            </li>
                                        @endforelse
                                    </ul>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 certificate-awards-inner">
                                        ...
                                        <ul>
                                            ...
                                            @empty
                                                <li class="font-15"><span
                                                        class="color-gray2">{{ __('No certificate to show') }}
                                                </li>
                                            @endforelse
                                        </ul>
                                    </div>
                                    <div class="col-md-6 certificate-awards-inner">
                                        ...
                                        <ul>
                                            ...
                                            @empty
                                                <li class="font-15"><span class="color-gray2">{{ __('No award to show') }}
                                                </li>
                                            @endforelse
                                        </ul>
                                    </div>
                            ...
                            @if (!get_option('private_mode') || !auth()->guest())
                                    ...
                                    <div class="instructor-details-left-inner-box my-others-courses bg-white radius-3">
                                        ...
                                        @if ($courses->hasPages())
                                            ...
                                            <div class="d-block" id="loadMoreBtn"><button type="button"
                                                    class="theme-btn theme-button2 load-more-btn loadMore">{{ __('Load More') }}
                                                    <span class="iconify"
                                ...
                                @elseif($user->role == USER_ROLE_ORGANIZATION)
                                    ...
                                    <div
                                        class="instructor-details-left-inner-box organization-single-tab-area bg-white radius-3">
                                        <!-- Tab panel nav list -->
                                        <div
                                            ...
                                            <div class="tab-pane fade show active" id="Instructors" role="tabpanel"
                                                ...
                                                <div class="organization-instructors-tab">
                                                    <div class="row top-instructor-content-wrap"
                                                        id="appendOrganizationInstructors">
                                                    ...
                                                    @if ($instructors->hasPages())
                                                        ...
                                                        <div class="d-block" id="organizationLoadMoreBtn">
                                                            <button type="button"
                                                                class="theme-btn theme-button2 load-more-btn instructorLoadMore">{{ __('Load More') }}
                                                                <span class="iconify"
                                                                    data-icon="icon-park-outline:loading-one"></span></button>
                                                        </div>
                                                    @endif
                            ...
                            <div class="course-info-box instructor-info-box bg-white p-0">
                                ...
                                <div class="follower-following-box mb-20">
                                    <div class="font-15 follower-item only-follower-item border-start-0">
                                        <h6 class="d-block color-heading font-15" id="followers">
                                            {{ count($user->followers) }}</h6>
                                        <span>{{ __('Followers') }}</span>
                                    </div>
                                    <div class="font-15 follower-item border-start-0 border-end-0">
                                        <h6 class="d-block color-heading font-15" id="following">
                                            {{ count($user->followings) }}</h6>
                                ...
                                <div class="instructor-social mt-20">
                                    <ul class="d-flex align-items-center">
                                        <li>
                                            <a
                                                href="{{ @$user->$userRelation->social_link ? $social_link->facebook : '' }}">
                                                <span class="iconify" data-icon="ant-design:facebook-filled"></span>
                                            </a>
                                        </li>
                                        <li>
                                            <a
                                                href="{{ @$user->$userRelation->social_link ? $social_link->twitter : '' }}">
                                                <span class="iconify" data-icon="ant-design:twitter-square-filled"></span>
                                            </a>
                                        </li>
                                        <li>
                                            <a
                                                href="{{ @$user->$userRelation->social_link ? $social_link->linkedin : '' }}">
                                                <span class="iconify" data-icon="ant-design:linkedin-filled"></span>
                                            </a>
                                        </li>
                                        <li>
                                            <a
                                                href="{{ @$user->$userRelation->social_link ? $social_link->pinterest : '' }}">
